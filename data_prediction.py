...
def data_prediction():
    ...
    df_securite = df_securite[df_securite['date'].str.contains('2023')]
    ...
    df_securite['insecurite'] = df_securite['insecurite'].apply(lambda x: x if x==x else 0)
    ...
    df_filtre_chomage_par_departement = df_chomage[df_chomage['Libelle'].str.contains('département - Nord| département - Pas-de-Calais| département - Somme| département - Oise| département - Aisne')].copy()
    df_filtre_chomage_par_departement_annee_2022 =  df_filtre_chomage_par_departement[df_filtre_chomage_par_departement['Annee'].str.contains('2023')].copy()
